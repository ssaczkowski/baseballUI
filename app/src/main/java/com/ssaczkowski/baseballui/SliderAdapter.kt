...
class SliderAdapter(var context: Context) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        if (position == 0) {
            ...
            view.slide_textView_point1.setTypeface(null, Typeface.BOLD)
            ...
            view.slide_textView_point2.setTypeface(null, Typeface.BOLD)
            view.slide_textView_point2.setTextColor(context.resources.getColor(R.color.colorTransparentWhite))
        } else if (position == 2) {
            ...
            view.slide_textView_point3.setTypeface(null, Typeface.BOLD)
        }
